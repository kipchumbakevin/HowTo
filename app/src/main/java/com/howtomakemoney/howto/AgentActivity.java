    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InterstitialAdListener interstitialAdListener = new InterstitialAdListener() {
            ...
            public void onInterstitialDismissed(Ad ad) {
                ...
                Intent intent = new Intent(AgentActivity.this,InsuranceActivity.class);
        ...
        interstitialAd.loadAd(
                interstitialAd.buildLoadAdConfig()
                        ...
                        .build());
        setText(getString(R.string.agent));

        learnmore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Uri uri = Uri.parse("https://www.thebalancecareers.com/insurance-agent-524871");
                ...
                try {
                    ...
                    startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("https://www.thebalancecareers.com/insurance-agent-524871")));
                }
            }
        });
    }
